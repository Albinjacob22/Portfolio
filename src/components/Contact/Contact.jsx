...
const Contact = () => {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "21dc8a44-f7cd-4b38-8cda-e7aa4fe582df");
    ...
    <div id='contact' className='contact'>
        ...
        <div className="contact-section">
            ...
            <div className="contact-details">
                ...
                <img src={mail_icon} alt="" /> <p>albinjacobphilip@gmail.com</p>
                </div>
                <div className="contact-detail">
                <img src={call_icon} alt="" /> <p>+91-8078095874</p>   
                </div>
                <div className="contact-detail">
